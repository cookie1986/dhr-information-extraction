from scraper.fetch_html import fetch_html_content
from scraper.parse_html import parse_dhr_results, extract_data_from_section
from scraper.pagination import calculate_total_reports, calculate_total_pages
